...
import { getGameCategory, getGameImage, isChallengeCustomGame, resolveGameName } from '@/lib/gameAssets';
...
const CategoryDetailPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen text-white relative bg-void">
      <ParticleBackground />
        ...
        {challengesLoading ? (
          ...
          challenges.map((challenge: any) => {
            ...
            <button
              ...
              className="w-full flex items-center gap-3 p-3 rounded-lg border border-gray-700/50 bg-[#0B0E13] hover:border-purple-500/35 hover:bg-[#0B0E13]/80 transition-all active:scale-[0.98]"
            >
                ...
                <div className="flex items-start justify-between gap-2 mb-1">
                  ...
                  <span className={`
                    ...
                    ${status === 'active' || status === 'Open'
                      ...
                      : 'bg-purple-500/15 text-purple-200 border border-purple-500/35'
                    }
                  `}>
