  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center">
      ...
      <div
        ...
        className={`
          relative w-full sm:w-[90vw] max-w-2xl max-h-[90vh] sm:max-h-[90vh] ${isTournamentModal ? 'overflow-y-auto' : 'overflow-hidden'} rounded-t-2xl sm:rounded-xl border border-purple/25
          bg-gradient-to-br from-void/98 via-[#140521]/96 to-void/98 backdrop-blur-md
          shadow-[0_0_48px_rgba(0,0,0,0.55)]
      ...
      >
        ...
        {title && (
          <div className="px-4 py-3 border-b border-white/10">
            <div className="flex items-center justify-between">
              <h2 className="font-display text-lg font-bold text-gradient tracking-tight">
                {title}
              </h2>
        ...
        {/* Content */}
        <div
          className={`p-4 sm:p-5 ${isTournamentModal ? 'overflow-x-auto' : 'overflow-y-auto max-h-[calc(90vh-80px)]'} overscroll-contain`}
