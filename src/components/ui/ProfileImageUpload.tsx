...
export default function ProfileImageUpload({
  ...
  return (
    <div className={`relative ${sizeClasses[size]} rounded-full bg-zinc-900 grid place-items-center ring-2 ring-purple-500/45 overflow-hidden shadow-none cursor-pointer group`}>
      {image ? (
        <img
          src={image}
          alt="Profile"
        ...
        <Gamepad2 className={`${size === "sm" ? "h-8 w-8" : size === "md" ? "h-10 w-10" : "h-12 w-12"} text-purple-300`} />
      )}
