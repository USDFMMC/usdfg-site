...
const RightSidePanel: React.FC<RightSidePanelProps> = ({
      ...
      >
        <motion.div
          className="relative w-full h-[52px] px-4 flex items-center justify-between rounded-full
            ...
            border border-white/10 ring-1 ring-purple-500/20
  ...
  return (
    <>
      ...
      <motion.div
        ref={panelRef}
        className={`fixed right-0 bottom-0 z-50 w-full max-w-md bg-[#07080C]/98 backdrop-blur-md border-t border-l border-white/10 shadow-[0_-12px_40px_rgba(0,0,0,0.55)] ring-1 ring-purple-500/10 rounded-t-2xl flex flex-col ${className}`}
        style={{
          height: '90vh',
          maxHeight: '90vh',
      ...
      >
        ...
        {title && (
          <div className="panel-header px-4 py-3 border-b border-white/10 bg-[#07080C]/95 backdrop-blur-sm z-10 flex-shrink-0">
            <div className="flex items-center justify-between gap-3">
              <h2 className="text-lg font-bold bg-gradient-to-r from-purple-300 to-orange-300 bg-clip-text text-transparent truncate min-w-0 flex-1">
                {title}
              </h2>
