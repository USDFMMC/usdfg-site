...
interface TeamManagementModalProps {
  ...
  onClose: () => void;
  onTeamUpdated?: () => void;
  /** When opening from leaderboard "join this team", pre-fills the join field */
  prefillJoinTeamId?: string | null;
...
const TeamManagementModal: React.FC<TeamManagementModalProps> = ({
  ...
  useEffect(() => {
    if (prefillJoinTeamId) {
      setJoinTeamId(prefillJoinTeamId);
    }
  }, [prefillJoinTeamId]);
  ...
  const handleLeaveTeam = async () => {
    ...
    const ok = await requestAppConfirm({
      ...
      message: `Are you sure you want to leave ${userTeam.teamName}?`,
      confirmLabel: 'OK',
      cancelLabel: 'Cancel',
      destructive: true,
    });
  ...
  const handleRemoveMember = async (member: string) => {
    ...
    const ok = await requestAppConfirm({
      title: 'Please confirm',
      message: `Remove ${member.slice(0, 8)}...${member.slice(-4)} from ${userTeam.teamName}?`,
      confirmLabel: 'OK',
      cancelLabel: 'Cancel',
      destructive: true,
    });
        ...
        <div className="space-y-4">
          <div className="p-4 bg-zinc-800/50 border border-zinc-700 rounded-lg">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-white font-medium">{userTeam.totalEarned.toLocaleString()} USDFG</span>
              </div>
              <div className="flex justify-between">
                  ...
                  <div key={member} className="flex items-center justify-between text-xs gap-3">
                    <div className="flex items-center gap-2">
                      ...
                      {member === userTeam.teamKey && (
                        <span className="text-purple-300 text-xs">🔑 Key Holder</span>
                      )}
          ...
          {userTeam.teamKey === currentWallet ? (
            <div className="p-3 bg-purple-500/10 border border-purple-500/30 rounded-lg">
              <p className="text-purple-200 text-xs font-semibold mb-2">
          ...
          <div className="p-4 bg-zinc-800/50 border border-zinc-700 rounded-lg">
            ...
            <div className="space-y-2">
              <input
                ...
                maxLength={20}
                className="w-full px-3 py-2 bg-zinc-900/50 border border-zinc-700 rounded-lg text-sm text-white placeholder-zinc-500 focus:border-purple-500/50 focus:outline-none"
              />
              <ElegantButton
          ...
          <div className="p-4 bg-zinc-800/50 border border-zinc-700 rounded-lg">
            ...
            <div className="space-y-2">
              <input
                ...
                className="w-full px-3 py-2 bg-zinc-900/50 border border-zinc-700 rounded-lg text-sm text-white placeholder-zinc-500 focus:border-purple-500/50 focus:outline-none font-mono"
              />
              <ElegantButton
