...
const CATEGORIES: CategoryCard[] = [
  { key: 'FPS', label: 'FPS', icon: '🎯', liveCount: 0 },
  { key: 'SPORTS', label: 'SPORTS', icon: '⚽', liveCount: 0 },
  { key: 'FIGHTING', label: 'FIGHTING', icon: '🥊', liveCount: 0 },
  { key: 'RACING', label: 'RACING', icon: '🏎️', liveCount: 0 },
  { key: 'STRATEGY', label: 'STRATEGY', icon: '♟️', liveCount: 0 },
  { key: 'TOURNAMENTS', label: 'TOURNAMENTS', icon: '🏆', liveCount: 0 },
];
          ...
          return (
            <button
              ...
              className={`
                ...
                active:scale-[0.98] hover:border-purple-500/40
                aspect-[176/122] min-h-[100px] md:min-h-[110px]
                ${isSelected ? 'ring-2 ring-purple-500 ring-offset-2 ring-offset-[#040507]' : ''}
                ${isActive 
                  ? 'border-purple-500/50 shadow-[0_0_10px_rgba(124,58,237,0.2)]' 
                  : 'border-gray-600/40'
                }
              `}
              style={{
            ...
            >
              ...
              <div className="absolute bottom-2 left-2">
                <span 
                  className={`text-[10px] md:text-xs font-semibold uppercase tracking-wide ${isActive ? 'text-purple-200' : 'text-gray-400'}`}
              ...
              {isActive && (
                <div className="absolute inset-0 pointer-events-none rounded-lg" style={{ boxShadow: 'inset 0 0 20px rgba(124, 58, 237, 0.08)' }} />
              )}
            </button>
          );
        })}
