// Run this in your browser console on the Arena page
// Copy and paste this entire code into your browser's console

// Get Firebase from the page (it's already loaded)
