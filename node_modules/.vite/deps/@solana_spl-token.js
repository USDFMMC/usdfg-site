...
// node_modules/@solana/codecs/node_modules/@solana/codecs-strings/dist/index.browser.mjs
...
function assertIsFixedSize2(codec) {
  if (!isFixedSize3(codec)) {
    throw new SolanaError3(SOLANA_ERROR__CODECS__EXPECTED_FIXED_LENGTH3);
  }
}
...
function getTokenGroupState(mint) {
  ...
  if (extensionData !== null) {
    ...
    return {
      updateAuthority: updateAuthority?.equals(PublicKey.default) ? void 0 : updateAuthority,
      mint: mint2,
      size,
      maxSize
    };
