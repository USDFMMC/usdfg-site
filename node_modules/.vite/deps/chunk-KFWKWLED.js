...
import {
  ...
  keccak_256,
  numberToHex
} from "./chunk-4MKD2CC6.js";
import {
  Chi,
  HashMD as HashMD2,
  Maj,
  sha256
} from "./chunk-KR3SNR3Q.js";
import {
  ...
  utf8ToBytes,
  validateObject
} from "./chunk-PUOXHVJE.js";
import {
  clean,
  createHasher,
  rotl as rotl2
} from "./chunk-XIJ6CS2S.js";
import {
  require_elliptic
} from "./chunk-QGHCWD3W.js";
import {
  HashMD
} from "./chunk-XXISVLVU.js";
import {
  rotl,
  wrapConstructor
} from "./chunk-IGDDSDLM.js";
import {
  require_events
} from "./chunk-XWCVQMLT.js";
import {
  __commonJS,
  __esm,
  __export,
...
P.toPrecision = function(sd, rm) {
  ...
  return stringify2(x6, sd <= x6.e || x6.e <= Big2.NE || x6.e >= Big2.PE, !!n5);
};
P.valueOf = function() {
  var x6 = this, Big2 = x6.constructor;
  if (Big2.strict === true) {
...
var BlockchainApiController = {
  ...
  async fetchSwapQuote({ amount, userAddress, from: from17, to: to2, gasPrice }) {
    const isSupported = await BlockchainApiController.isNetworkSupported(ChainController.state.activeCaipNetwork?.caipNetworkId);
    if (!isSupported) {
      return { quotes: [] };
    }
  ...
  async generateSwapCalldata({ amount, from: from17, to: to2, userAddress, disableEstimate }) {
    const isSupported = await BlockchainApiController.isNetworkSupported(ChainController.state.activeCaipNetwork?.caipNetworkId);
    if (!isSupported) {
  ...
  async generateApproveCalldata({ from: from17, to: to2, userAddress }) {
    const { st: st2, sv } = BlockchainApiController.getSdkProperties();
    const isSupported = await BlockchainApiController.isNetworkSupported(ChainController.state.activeCaipNetwork?.caipNetworkId);
    if (!isSupported) {
      throw new Error("Network not supported for Swaps");
...
var i2 = class _i extends n {
  constructor(e3) {
    super(e3), this.events = new import_events.EventEmitter(), this.interval = s2, this.interval = e3?.interval || s2;
  }
...
function k2(r3) {
  return g(i3({}, r3), { level: r3?.level || c3.level });
}
function v(r3, e3 = n2) {
  return r3[e3] || "";
}
...
var __spreadArray = function(to2, from17, pack) {
  if (pack || arguments.length === 2) for (var i5 = 0, l8 = from17.length, ar3; i5 < l8; i5++) {
    if (ar3 || !(i5 in from17)) {
      if (!ar3) ar3 = Array.prototype.slice.call(from17, 0, i5);
      ar3[i5] = from17[i5];
    }
  }
  return to2.concat(ar3 || Array.prototype.slice.call(from17));
};
var BrowserInfo = (
  /** @class */
  /* @__PURE__ */ function() {
...
function encode6(num2, out, offset) {
  out = out || [];
  offset = offset || 0;
...
var w2 = () => typeof WebSocket < "u" || typeof globalThis < "u" && typeof globalThis.WebSocket < "u" || typeof window < "u" && typeof window.WebSocket < "u" || typeof self < "u" && typeof self.WebSocket < "u";
...
var f5 = class {
  ...
  emitError(e3) {
    const t2 = this.parseError(new Error(e3?.message || `WebSocket connection failed for host: ${d3(this.url)}`));
...
function sr2(r3, e3) {
  ...
  function d5(l8) {
    ...
    for (var j4 = (D2 - I3) * u3 + 1 >>> 0, T4 = new Uint8Array(j4); I3 !== D2; ) {
      for (var q2 = l8[I3], J4 = 0, K6 = j4 - 1; (q2 !== 0 || J4 < x6) && K6 !== -1; K6--, J4++) q2 += 256 * T4[K6] >>> 0, T4[K6] = q2 % a3 >>> 0, q2 = q2 / a3 >>> 0;
  ...
  function g4(l8) {
    ...
    if (l8[b4] !== " ") {
      ...
      if (l8[b4] !== " ") {
        for (var K6 = D2 - I3; K6 !== D2 && j4[K6] === 0; ) K6++;
        for (var H2 = new Uint8Array(x6 + (D2 - K6)), me3 = x6; K6 !== D2; ) H2[me3++] = j4[K6++];
        return H2;
      }
    }
  }
...
var ConnectorController = {
  ...
  getAnnouncedConnectorRdns() {
    return state15.connectors.filter((c7) => c7.type === "ANNOUNCED").map((c7) => c7.info?.rdns);
  },
  getConnectorById(id) {
  ...
  getConnector(id, rdns) {
    ...
    return connectorsByNamespace.find((c7) => c7.explorerId === id || c7.info?.rdns === rdns);
  },
...
function getContractError2(err, { abi, address, args, docsPath, functionName, sender }) {
  ...
  const cause = (() => {
    ...
    if ([EXECUTION_REVERTED_ERROR_CODE, InternalRpcError.code].includes(code2) && (data || details || message || shortMessage) || code2 === InvalidInputRpcError.code && details === "execution reverted" && data) {
...
async function recoverPublicKey2({ hash, signature }) {
  ...
  const { secp256k1: secp256k14 } = await import("./secp256k1-3AEK2LHP.js");
  const signature_ = (() => {
    if (typeof signature === "object" && "r" in signature && "s" in signature) {
      const { r: r3, s: s4, v: v5, yParity } = signature;
      const yParityOrV2 = Number(yParity ?? v5);
      const recoveryBit2 = toRecoveryBit(yParityOrV2);
      return new secp256k14.Signature(hexToBigInt(r3), hexToBigInt(s4)).addRecoveryBit(recoveryBit2);
    }
...
var EstimateGasExecutionError2 = class extends BaseError {
  constructor(cause, { account, docsPath, chain, data, gas, gasPrice, maxFeePerGas, maxPriorityFeePerGas, nonce, to: to2, value }) {
...
var BaseFeeScalarError2 = class extends BaseError {
  constructor() {
...
var Eip1559FeesNotSupportedError2 = class extends BaseError {
  constructor() {
...
var MaxFeePerGasTooLowError2 = class extends BaseError {
...
var BlockNotFoundError2 = class extends BaseError {
...
function formatTransaction2(transaction, _4) {
  const transaction_ = {
    ...transaction,
    blockHash: transaction.blockHash ? transaction.blockHash : null,
    blockNumber: transaction.blockNumber ? BigInt(transaction.blockNumber) : null,
...
function formatBlock2(block, _4) {
  const transactions = (block.transactions ?? []).map((transaction) => {
    if (typeof transaction === "string")
      return transaction;
...
function blobsToCommitments2(parameters) {
  ...
  return to2 === "bytes" ? commitments : commitments.map((x6) => bytesToHex(x6));
}
...
function blobsToProofs2(parameters) {
  ...
  return to2 === "bytes" ? proofs : proofs.map((x6) => bytesToHex(x6));
}
...
function sha2566(value, to_) {
  const to2 = to_ || "hex";
  const bytes = sha2565(isHex(value, { strict: false }) ? toBytes(value) : value);
  if (to2 === "bytes")
    return bytes;
  return toHex(bytes);
}
...
function toBlobs2(parameters) {
  ...
  return to2 === "bytes" ? blobs.map((x6) => x6.bytes) : blobs.map((x6) => bytesToHex(x6.bytes));
}
...
async function fillTransaction(client, parameters) {
  const { account = client.account, accessList, authorizationList, chain = client.chain, blobVersionedHashes, blobs, data, gas, gasPrice, maxFeePerBlobGas, maxFeePerGas, maxPriorityFeePerGas, nonce: nonce_, nonceManager: nonceManager3, to: to2, type, value, ...rest } = parameters;
  const nonce = await (async () => {
    ...
    const chainId = chain ? chain.id : await getAction2(client, getChainId2, "getChainId")({});
    return await nonceManager3.consume({
  ...
  try {
    ...
    const format2 = chain?.formatters?.transaction?.format || formatTransaction2;
    ...
    const feeMultiplier = await (async () => {
      if (typeof chain?.fees?.baseFeeMultiplier === "function") {
        const block = await getAction2(client, getBlock2, "getBlock")({});
        return chain.fees.baseFeeMultiplier({
          block,
          client,
          request: parameters
...
var supportsFillTransaction = new LruMap2(128);
async function prepareTransactionRequest2(client, args) {
  const { account: account_ = client.account, chain, nonceManager: nonceManager3, parameters = defaultParameters2 } = args;
  let chainId;
  ...
  if (parameters.includes("nonce") && typeof nonce === "undefined" && account && nonceManager3) {
    const chainId2 = await getChainId3();
    nonce = await nonceManager3.consume({
  ...
  const fillResult = attemptFill ? await getAction2(client, fillTransaction, "fillTransaction")({ ...args, nonce }).then((result) => {
    const { chainId: chainId2, from: from17, gas: gas2, gasPrice, nonce: nonce2, maxFeePerBlobGas, maxFeePerGas, maxPriorityFeePerGas, type: type2 } = result.transaction;
    ...
    const error = e3;
    const unsupported = error.walk((e4) => {
      const error2 = e4;
...
var AccountTypeNotSupportedError2 = class extends BaseError {
...
function formatTransactionReceipt2(transactionReceipt, _4) {
  const receipt = {
    ...transactionReceipt,
    blockNumber: transactionReceipt.blockNumber ? BigInt(transactionReceipt.blockNumber) : null,
    contractAddress: transactionReceipt.contractAddress ? transactionReceipt.contractAddress : null,
...
function toYParitySignatureArray2(transaction, signature_) {
  ...
  const yParity_ = (() => {
    ...
    return v5 === 27n ? "0x" : numberToHex2(1);
  })();
...
var SHA1 = class extends HashMD2 {
  ...
  get() {
    const { A: A2, B: B3, C: C5, D: D2, E: E4 } = this;
    return [A2, B3, C5, D2, E4];
  }
  set(A2, B3, C5, D2, E4) {
    this.A = A2 | 0;
    this.B = B3 | 0;
  ...
  process(view, offset) {
    ...
    for (let i5 = 16; i5 < 80; i5++)
      SHA1_W[i5] = rotl2(SHA1_W[i5 - 3] ^ SHA1_W[i5 - 8] ^ SHA1_W[i5 - 14] ^ SHA1_W[i5 - 16], 1);
    let { A: A2, B: B3, C: C5, D: D2, E: E4 } = this;
    for (let i5 = 0; i5 < 80; i5++) {
      ...
      const T4 = rotl2(A2, 5) + F3 + E4 + K6 + SHA1_W[i5] | 0;
      E4 = D2;
      D2 = C5;
      C5 = rotl2(B3, 30);
      B3 = A2;
...
var K4 = Array.from({ length: 64 }, (_4, i5) => Math.floor(p32 * Math.abs(Math.sin(i5 + 1))));
...
var MD5 = class extends HashMD2 {
  ...
  get() {
    const { A: A2, B: B3, C: C5, D: D2 } = this;
    return [A2, B3, C5, D2];
  }
  set(A2, B3, C5, D2) {
    this.A = A2 | 0;
  ...
  process(view, offset) {
    ...
    for (let i5 = 0; i5 < 64; i5++) {
      ...
      F3 = F3 + A2 + K4[i5] + MD5_W[g4];
      A2 = D2;
      D2 = C5;
      C5 = B3;
      B3 = B3 + rotl2(F3, s4[i5 % 4]);
    }
    A2 = A2 + this.A | 0;
    B3 = B3 + this.B | 0;
    C5 = C5 + this.C | 0;
    D2 = D2 + this.D | 0;
    this.set(A2, B3, C5, D2);
  }
  roundClean() {
    clean(MD5_W);
  }
...
var idxLR = (() => {
  ...
  for (let i5 = 0; i5 < 4; i5++)
    for (let j4 of res)
      j4.push(j4[i5].map((k5) => Rho160[k5]));
  return res;
})();
var idxL2 = (() => idxLR[0])();
var idxR2 = (() => idxLR[1])();
...
function ripemd_f(group, x6, y5, z4) {
  if (group === 0)
    return x6 ^ y5 ^ z4;
  if (group === 1)
    return x6 & y5 | ~x6 & z4;
...
var RIPEMD1602 = class extends HashMD2 {
  ...
  process(view, offset) {
    ...
    for (let group = 0; group < 5; group++) {
      ...
      for (let i5 = 0; i5 < 16; i5++) {
        const tl = rotl2(al + ripemd_f(group, bl, cl, dl) + BUF_160[rl[i5]] + hbl, sl[i5]) + el | 0;
        al = el, el = dl, dl = rotl2(cl, 10) | 0, cl = bl, bl = tl;
      }
      for (let i5 = 0; i5 < 16; i5++) {
        const tr4 = rotl2(ar3 + ripemd_f(rGroup, br3, cr3, dr3) + BUF_160[rr4[i5]] + hbr, sr3[i5]) + er4 | 0;
  ...
  return new Promise((resolve, reject) => {
    ...
    (async () => {
      ...
      try {
        ...
        resolve(await fn3({ signal: controller?.signal || null }));
      } catch (err) {
...
var hexes2 = Array.from({ length: 256 }, (_4, i5) => i5.toString(16).padStart(2, "0"));
...
function concatBytes3(...arrays) {
  ...
  for (let i5 = 0, pad5 = 0; i5 < arrays.length; i5++) {
    const a3 = arrays[i5];
    res.set(a3, pad5);
    pad5 += a3.length;
  }
...
function Chi2(a3, b4, c7) {
  return a3 & b4 ^ ~a3 & c7;
}
function Maj2(a3, b4, c7) {
...
var SHA12 = class extends HashMD3 {
  ...
  process(view, offset) {
    ...
    for (let i5 = 16; i5 < 80; i5++)
      SHA1_W2[i5] = rotl3(SHA1_W2[i5 - 3] ^ SHA1_W2[i5 - 8] ^ SHA1_W2[i5 - 14] ^ SHA1_W2[i5 - 16], 1);
    let { A: A2, B: B3, C: C5, D: D2, E: E4 } = this;
    for (let i5 = 0; i5 < 80; i5++) {
      let F3, K6;
      if (i5 < 20) {
      ...
      const T4 = rotl3(A2, 5) + F3 + E4 + K6 + SHA1_W2[i5] | 0;
      E4 = D2;
      D2 = C5;
      C5 = rotl3(B3, 30);
      B3 = A2;
...
var K5 = Array.from({ length: 64 }, (_4, i5) => Math.floor(p322 * Math.abs(Math.sin(i5 + 1))));
...
var MD52 = class extends HashMD3 {
  ...
  process(view, offset) {
    ...
    for (let i5 = 0; i5 < 64; i5++) {
      ...
      F3 = F3 + A2 + K5[i5] + MD5_W2[g4];
      A2 = D2;
      D2 = C5;
      C5 = B3;
      B3 = B3 + rotl3(F3, s4[i5 % 4]);
    }
    A2 = A2 + this.A | 0;
    B3 = B3 + this.B | 0;
    C5 = C5 + this.C | 0;
...
var idxLR2 = (() => {
  ...
  for (let i5 = 0; i5 < 4; i5++)
    for (let j4 of res)
      j4.push(j4[i5].map((k5) => Rho1602[k5]));
  return res;
})();
var idxL3 = (() => idxLR2[0])();
var idxR3 = (() => idxLR2[1])();
...
var shiftsL1602 = idxL3.map((idx, i5) => idx.map((j4) => shifts1602[i5][j4]));
var shiftsR1602 = idxR3.map((idx, i5) => idx.map((j4) => shifts1602[i5][j4]));
...
function ripemd_f2(group, x6, y5, z4) {
  if (group === 0)
    return x6 ^ y5 ^ z4;
  if (group === 1)
    return x6 & y5 | ~x6 & z4;
...
var RIPEMD1603 = class extends HashMD3 {
  ...
  process(view, offset) {
    ...
    for (let group = 0; group < 5; group++) {
      ...
      const sl = shiftsL1602[group], sr3 = shiftsR1602[group];
      for (let i5 = 0; i5 < 16; i5++) {
        const tl = rotl3(al + ripemd_f2(group, bl, cl, dl) + BUF_1602[rl[i5]] + hbl, sl[i5]) + el | 0;
        al = el, el = dl, dl = rotl3(cl, 10) | 0, cl = bl, bl = tl;
      }
      for (let i5 = 0; i5 < 16; i5++) {
        const tr4 = rotl3(ar3 + ripemd_f2(rGroup, br3, cr3, dr3) + BUF_1602[rr4[i5]] + hbr, sr3[i5]) + er4 | 0;
        ar3 = er4, er4 = dr3, dr3 = rotl3(cr3, 10) | 0, cr3 = br3, br3 = tr4;
      }
    }
    this.set(this.h1 + cl + dr3 | 0, this.h2 + dl + er4 | 0, this.h3 + el + ar3 | 0, this.h4 + al + br3 | 0, this.h0 + bl + cr3 | 0);
  }
...
var ripemd1605 = createHasher2(() => new RIPEMD1603());
...
var SHA3_ROTL = [];
var _SHA3_IOTA = [];
for (let round2 = 0, R2 = _1n, x6 = 1, y5 = 0; round2 < 24; round2++) {
...
var SHA2562 = class extends HashMD3 {
  ...
  process(view, offset) {
    ...
    for (let i5 = 0; i5 < 64; i5++) {
      ...
      const T1 = H2 + sigma1 + Chi2(E4, F3, G3) + SHA256_K[i5] + SHA256_W[i5] | 0;
      const sigma0 = rotr(A2, 2) ^ rotr(A2, 13) ^ rotr(A2, 22);
      const T22 = sigma0 + Maj2(A2, B3, C5) | 0;
      H2 = G3;
      G3 = F3;
      F3 = E4;
      E4 = D2 + T1 | 0;
...
var sha2567 = createHasher2(() => new SHA2562());
...
var HMAC = class extends Hash {
  constructor(hash, _key) {
    ...
    pad5.set(key.length > blockLen ? hash.create().update(key).digest() : key);
    for (let i5 = 0; i5 < pad5.length; i5++)
      pad5[i5] ^= 54;
...
function invert(number, modulo) {
  ...
  let b4 = modulo;
  let x6 = _0n2, y5 = _1n2, u3 = _1n2, v5 = _0n2;
  while (a3 !== _0n2) {
    const q2 = b4 / a3;
    const r3 = b4 % a3;
    const m4 = x6 - u3 * q2;
    const n5 = y5 - v5 * q2;
    b4 = a3, a3 = r3, x6 = u3, y5 = v5, u3 = m4, v5 = n5;
  }
  const gcd = b4;
  if (gcd !== _1n2)
...
function sqrt5mod8(Fp, n5) {
  ...
  const i5 = Fp.mul(Fp.mul(nv, _2n2), v5);
  const root = Fp.mul(nv, Fp.sub(i5, Fp.ONE));
  if (!Fp.eql(Fp.sqr(root), n5))
    throw new Error("Cannot find square root");
  return root;
}
function tonelliShanks(P6) {
  ...
  if (S3 === 1)
    return sqrt3mod4;
  let cc = _Fp.pow(Z2, Q4);
  const Q1div2 = (Q4 + _1n2) / _2n2;
  return function tonelliSlow(Fp, n5) {
    ...
    while (!Fp.eql(t2, Fp.ONE)) {
      ...
      const exponent = _1n2 << BigInt(M4 - i5 - 1);
      const b4 = Fp.pow(c7, exponent);
      M4 = i5;
      c7 = Fp.sqr(b4);
      t2 = Fp.mul(t2, c7);
      R2 = Fp.mul(R2, b4);
...
function FpInvertBatch(Fp, nums, passZero = false) {
  ...
  const multipliedAcc = nums.reduce((acc, num2, i5) => {
    if (Fp.is0(num2))
      return acc;
    inverted[i5] = acc;
  ...
  nums.reduceRight((acc, num2, i5) => {
    if (Fp.is0(num2))
      return acc;
    inverted[i5] = Fp.mul(acc, inverted[i5]);
    return Fp.mul(acc, num2);
  }, invertedAcc);
  return inverted;
}
...
function validateMSMPoints(points, c7) {
  ...
  points.forEach((p4, i5) => {
    if (!(p4 instanceof c7))
      throw new Error("invalid point at index " + i5);
  });
}
function validateMSMScalars(scalars, field) {
  if (!Array.isArray(scalars))
    throw new Error("array of scalars expected");
  scalars.forEach((s4, i5) => {
    if (!field.isValid(s4))
      throw new Error("invalid scalar at index " + i5);
  });
}
...
function wNAF(c7, bits) {
  return {
    ...
    unsafeLadder(elm, n5, p4 = c7.ZERO) {
      let d5 = elm;
      while (n5 > _0n3) {
        if (n5 & _1n3)
          p4 = p4.add(d5);
    ...
    wNAF(W2, precomputes, n5) {
      let p4 = c7.ZERO;
      let f7 = c7.BASE;
      const wo3 = calcWOpts(W2, bits);
      for (let window2 = 0; window2 < wo3.windows; window2++) {
        const { nextN, offset, isZero, isNeg, isNegF, offsetF } = calcOffsets(n5, window2, wo3);
        n5 = nextN;
        if (isZero) {
     ...
     * @returns point
     */
    wNAFUnsafe(W2, precomputes, n5, acc = c7.ZERO) {
      const wo3 = calcWOpts(W2, bits);
      for (let window2 = 0; window2 < wo3.windows; window2++) {
        if (n5 === _0n3)
          break;
        const { nextN, offset, isZero, isNeg } = calcOffsets(n5, window2, wo3);
        n5 = nextN;
        if (isZero) {
          continue;
        } else {
    ...
    getPrecomputes(W2, P6, transform) {
      let comp = pointPrecomputes.get(P6);
      if (!comp) {
        comp = this.precomputeWindow(P6, W2);
        if (W2 !== 1)
    ...
    wNAFCached(P6, n5, transform) {
      const W2 = getW(P6);
      return this.wNAF(W2, this.getPrecomputes(W2, P6, transform), n5);
    },
    wNAFCachedUnsafe(P6, n5, transform, prev) {
      const W2 = getW(P6);
      if (W2 === 1)
        return this.unsafeLadder(P6, n5, prev);
      return this.wNAFUnsafe(W2, this.getPrecomputes(W2, P6, transform), n5, prev);
    },
...
function pippenger(c7, fieldN, points, scalars) {
  ...
  let sum = zero;
  for (let i5 = lastBits; i5 >= 0; i5 -= windowSize) {
    buckets.fill(zero);
    for (let j4 = 0; j4 < slength; j4++) {
      const scalar = scalars[j4];
      const wbits2 = Number(scalar >> BigInt(i5) & MASK);
...
function weierstrassPoints(opts) {
  ...
  function weierstrassEquation(x6) {
    ...
    return Fp.add(Fp.add(x32, Fp.mul(x6, a3)), b4);
  }
  ...
  function normPrivateKeyToScalar(key) {
    ...
    if (wrapPrivateKey)
      num2 = mod(num2, N10);
    aInRange("private key", num2, _1n4, N10);
    return num2;
  }
  ...
  class Point2 {
    ...
    static fromAffine(p4) {
      const { x: x6, y: y5 } = p4 || {};
      if (!p4 || !Fp.isValid(x6) || !Fp.isValid(y5))
        throw new Error("invalid affine point");
      if (p4 instanceof Point2)
        throw new Error("projective point not allowed");
      const is0 = (i5) => Fp.eql(i5, Fp.ZERO);
      if (is0(x6) && is0(y5))
        return Point2.ZERO;
      return new Point2(x6, y5, Fp.ONE);
    }
    get x() {
      return this.toAffine().x;
    }
    ...
    static normalizeZ(points) {
      ...
      return points.map((p4, i5) => p4.toAffine(toInv[i5])).map(Point2.fromAffine);
    }
    /**
     ...
     */
    static fromHex(hex) {
      const P6 = Point2.fromAffine(fromBytes5(ensureBytes("pointHex", hex)));
      P6.assertValidity();
      return P6;
    }
     ...
     */
    multiplyUnsafe(sc) {
      const { endo: endo2, n: N10 } = CURVE;
      aInRange("scalar", sc, _0n4, N10);
    ...
    multiply(scalar) {
      const { endo: endo2, n: N10 } = CURVE;
      aInRange("scalar", scalar, _1n4, N10);
      let point, fake;
      if (endo2) {
    ...
    multiplyAndAddUnsafe(Q4, a3, b4) {
      ...
      const mul = (P6, a4) => a4 === _0n4 || a4 === _1n4 || !P6.equals(G3) ? P6.multiplyUnsafe(a4) : P6.multiply(a4);
...
function weierstrass(curveDef) {
  ...
  const slcNum = (b4, from17, to2) => bytesToNumberBE(b4.slice(from17, to2));
  class Signature {
    constructor(r3, s4, recovery) {
      aInRange("r", r3, _1n4, CURVE_ORDER);
      aInRange("s", s4, _1n4, CURVE_ORDER);
      this.r = r3;
      this.s = s4;
      if (recovery != null)
    ...
    static fromDER(hex) {
      const { r: r3, s: s4 } = DER.toSig(ensureBytes("DER", hex));
    ...
    recoverPublicKey(msgHash) {
      const { r: r3, s: s4, recovery: rec } = this;
      ...
      const R2 = Point2.fromHex(prefix + numToSizedHex(radj, Fp.BYTES));
      const ir3 = invN(radj);
      const u1 = modN2(-h6 * ir3);
      const u22 = modN2(s4 * ir3);
      const Q4 = Point2.BASE.multiplyAndAddUnsafe(R2, u1, u22);
      if (!Q4)
  ...
  function prepSig(msgHash, privateKey, opts = defaultSigOpts) {
    ...
    function k2sig(kBytes) {
      ...
      if (!isWithinCurveOrder(k5))
        return;
      const ik = invN(k5);
      const q2 = Point2.BASE.multiply(k5).toAffine();
      const r3 = modN2(q2.x);
      if (r3 === _0n4)
        return;
      const s4 = modN2(ik * modN2(m4 + r3 * d5));
      if (s4 === _0n4)
        return;
  ...
  function verify(signature, msgHash, publicKey, opts = defaultVerOpts) {
    ...
    const { r: r3, s: s4 } = _sig;
    const h6 = bits2int_modN(msgHash);
    const is2 = invN(s4);
    const u1 = modN2(h6 * is2);
    const u22 = modN2(r3 * is2);
    const R2 = Point2.BASE.multiplyAndAddUnsafe(P6, u1, u22)?.toAffine();
    if (!R2)
      return false;
    const v5 = modN2(R2.x);
    return v5 === r3;
...
function SWUFpSqrtRatio(Fp, Z2) {
  ...
  const c62 = Fp.pow(Z2, c22);
  const c7 = Fp.pow(Z2, (c22 + _1n4) / _2n3);
  let sqrtRatio = (u3, v5) => {
    let tv1 = c62;
    let tv2 = Fp.pow(v5, c42);
    let tv3 = Fp.sqr(tv2);
    tv3 = Fp.mul(tv3, v5);
  ...
  if (Fp.ORDER % _4n2 === _3n2) {
    ...
    sqrtRatio = (u3, v5) => {
      let tv1 = Fp.sqr(v5);
      const tv2 = Fp.mul(u3, v5);
      tv1 = Fp.mul(tv1, tv2);
      let y1 = Fp.pow(tv1, c12);
      y1 = Fp.mul(y1, tv2);
      const y22 = Fp.mul(y1, c23);
      const tv3 = Fp.mul(Fp.sqr(y1), v5);
...
function mapToCurveSimpleSWU(Fp, opts) {
  ...
  return (u3) => {
    let tv1, tv2, tv3, tv4, tv5, tv6, x6, y5;
    tv1 = Fp.sqr(u3);
    ...
    const e1 = Fp.isOdd(u3) === Fp.isOdd(y5);
...
function expand_message_xmd(msg, DST, lenInBytes, H2) {
  ...
  for (let i5 = 1; i5 <= ell; i5++) {
    const args = [strxor(b_0, b4[i5 - 1]), i2osp(i5 + 1, 1), DST_prime];
    b4[i5] = H2(concatBytes(...args));
  }
  const pseudo_random_bytes = concatBytes(...b4);
  return pseudo_random_bytes.slice(0, lenInBytes);
}
function expand_message_xof(msg, DST, lenInBytes, k5, H2) {
  abytes(msg);
  abytes(DST);
  anum(lenInBytes);
  if (DST.length > 255) {
...
function hash_to_field(msg, count, options) {
  ...
  const { p: p4, k: k5, m: m4, hash, expand, DST: _DST } = options;
  abytes(msg);
  anum(count);
  ...
  for (let i5 = 0; i5 < count; i5++) {
    ...
    for (let j4 = 0; j4 < m4; j4++) {
      const elm_offset = L3 * (j4 + i5 * m4);
      const tv = prb.subarray(elm_offset, elm_offset + L3);
      e3[j4] = mod(os2ip(tv), p4);
    }
    u3[i5] = e3;
  }
  return u3;
...
function isogenyMap(field, map) {
  const coeff = map.map((i5) => Array.from(i5).reverse());
  return (x6, y5) => {
    const [xn2, xd, yn3, yd] = coeff.map((val) => val.reduce((acc, i5) => field.add(field.mul(acc, x6), i5)));
    const [xd_inv, yd_inv] = FpInvertBatch(field, [xd, yd], true);
    x6 = field.mul(xn2, xd_inv);
    y5 = field.mul(y5, field.mul(yn3, yd_inv));
    return { x: x6, y: y5 };
  };
}
...
function taggedHash(tag, ...messages) {
  ...
  if (tagP === void 0) {
    const tagH = sha2567(Uint8Array.from(tag, (c7) => c7.charCodeAt(0)));
    tagP = concatBytes(tagH, tagH);
    TAGGED_HASH_PREFIXES[tag] = tagP;
  }
  return sha2567(concatBytes(tagP, ...messages));
}
...
function schnorrSign(message, privateKey, auxRand = randomBytes(32)) {
  ...
  const t2 = numTo32b(d5 ^ num(taggedHash("BIP0340/aux", a3)));
  const rand = taggedHash("BIP0340/nonce", t2, px, m4);
  ...
  sig.set(rx, 0);
  sig.set(numTo32b(modN(k5 + e3 * d5)), 32);
...
function schnorrVerify(signature, message, publicKey) {
  ...
  try {
    ...
    if (!inRange(s4, _1n5, secp256k1N))
      return false;
    const e3 = challenge(numTo32b(r3), pointToBytes(P6), m4);
    const R2 = GmulAdd(P6, s4, modN(-e3));
...
var secp256k1_hasher = (() => createHasher3(secp256k12.ProjectivePoint, (scalars) => {
  const { x: x6, y: y5 } = mapSWU(Fpk1.create(scalars[0]));
  return isoMap(x6, y5);
}, {
        ...
        const fetch2 = async (i5 = 0) => {
          ...
          try {
            ...
            if (i5 === transports.length - 1)
              throw err;
            includes ??= transports.slice(i5 + 1).some((transport3) => {
...
//# sourceMappingURL=chunk-KFWKWLED.js.map
