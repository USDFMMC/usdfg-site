import {
  require_dijkstra
} from "./chunk-7NVM27MO.js";
import {
  createSignInMessageText
} from "./chunk-2XSPJF5C.js";
import {
  SOLANA_MAINNET_CHAIN
} from "./chunk-OBZ7C4L4.js";
import {
...
var RemoteConnectionModal = class extends EmbeddedModal {
  ...
  populateQRCode(qrUrl) {
    ...
    return __awaiter2(this, void 0, void 0, function* () {
      ...
      if (qrcodeContainer) {
        const qrCodeElement = yield import_qrcode.default.toCanvas(qrUrl, { width: 200, margin: 0 });
...
var SolanaMobileWalletAdapterRemoteWalletName = "Remote Mobile Wallet Adapter";
      ...
      try {
        ...
        return {
          account: Object.assign(Object.assign({}, signedInAccount !== null && signedInAccount !== void 0 ? signedInAccount : {
            address: import_bs58.default.encode(toUint8Array2(signedInAddress))
...
var RemoteSolanaMobileWalletAdapterWallet = class {
  constructor(config) {
    ...
    _RemoteSolanaMobileWalletAdapterWallet_performAuthorization.set(this, (signInPayload) => __awaiter2(this, void 0, void 0, function* () {
      try {
        ...
        return yield __classPrivateFieldGet$1(this, _RemoteSolanaMobileWalletAdapterWallet_transact, "f").call(this, (wallet) => __awaiter2(this, void 0, void 0, function* () {
          ...
          const authorizationResult = Object.assign(Object.assign({}, mwaAuthorizationResult), { accounts, chain: selectedChain, capabilities });
          Promise.all([
    ...
    _RemoteSolanaMobileWalletAdapterWallet_performSignTransactions.set(this, (transactions) => __awaiter2(this, void 0, void 0, function* () {
      ...
      try {
        return yield __classPrivateFieldGet$1(this, _RemoteSolanaMobileWalletAdapterWallet_transact, "f").call(this, (wallet) => __awaiter2(this, void 0, void 0, function* () {
          ...
          const signedTransactions = (yield wallet.signTransactions({
            payloads: transactions.map(fromUint8Array2)
          })).signed_payloads.map(toUint8Array2);
          return signedTransactions;
        }));
      } catch (e2) {
    ...
    _RemoteSolanaMobileWalletAdapterWallet_performSignAndSendTransaction.set(this, (transaction, options) => __awaiter2(this, void 0, void 0, function* () {
      ...
      try {
        return yield __classPrivateFieldGet$1(this, _RemoteSolanaMobileWalletAdapterWallet_transact, "f").call(this, (wallet) => __awaiter2(this, void 0, void 0, function* () {
          ...
          if (capabilities.supports_sign_and_send_transactions) {
            const signatures = (yield wallet.signAndSendTransactions(Object.assign(Object.assign({}, options), { payloads: [fromUint8Array2(transaction)] }))).signatures.map(toUint8Array2);
            return signatures[0];
          } else {
            throw new Error("connected wallet does not support signAndSendTransaction");
          }
    ...
    _RemoteSolanaMobileWalletAdapterWallet_signTransaction.set(this, (...inputs) => __awaiter2(this, void 0, void 0, function* () {
      return (yield __classPrivateFieldGet$1(this, _RemoteSolanaMobileWalletAdapterWallet_performSignTransactions, "f").call(this, inputs.map(({ transaction }) => transaction))).map((signedTransaction) => {
        return { signedTransaction };
      });
    }));
    ...
    _RemoteSolanaMobileWalletAdapterWallet_performSignIn.set(this, (input) => __awaiter2(this, void 0, void 0, function* () {
      ...
      try {
        ...
        return {
          account: Object.assign(Object.assign({}, signedInAccount !== null && signedInAccount !== void 0 ? signedInAccount : {
            address: import_bs58.default.encode(toUint8Array2(signedInAddress))
          }), { publicKey: toUint8Array2(signedInAddress), chains: (_h = signedInAccount === null || signedInAccount === void 0 ? void 0 : signedInAccount.chains) !== null && _h !== void 0 ? _h : __classPrivateFieldGet$1(this, _RemoteSolanaMobileWalletAdapterWallet_chains, "f"), features: (_j = signedInAccount === null || signedInAccount === void 0 ? void 0 : signedInAccount.features) !== null && _j !== void 0 ? _j : authorizationResult.capabilities.features }),
          signedMessage: toUint8Array2(authorizationResult.sign_in_result.signed_message),
          signature: toUint8Array2(authorizationResult.sign_in_result.signature)
        };
      } catch (e2) {
...
var SolanaMobileWalletAdapterRemoteWalletName2 = SolanaMobileWalletAdapterRemoteWalletName;
...
export {
  SolanaMobileWalletAdapterWalletName2 as SolanaMobileWalletAdapterWalletName,
  SolanaMobileWalletAdapterRemoteWalletName2 as SolanaMobileWalletAdapterRemoteWalletName,
...
//# sourceMappingURL=chunk-D3SEQ5HI.js.map
