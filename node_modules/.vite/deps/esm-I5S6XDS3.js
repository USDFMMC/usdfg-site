        ...
        return __generator2(this, function(_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [2, import_bs582.default.decode(signedTransaction)];
          }
        });
      });
    };
            ...
            case 0:
              ...
              return [4, this._sendRequest("signAllTransactionsV2", {
                transactions: transactions.map(function(transaction) {
                  return import_bs582.default.encode(transaction);
                })
              })];
            case 1:
              signedTransactions = _a.sent().transactions;
              return [2, signedTransactions.map(function(transaction) {
                return import_bs582.default.decode(transaction);
              })];
          }
        });
      });
        ...
        return __generator3(this, function(_b) {
          switch (_b.label) {
            ...
            case 2:
              ...
              return [2, import_bs583.default.decode(signedTransaction)];
            case 3:
              e_1 = _b.sent();
          ...
          switch (_b.label) {
            ...
            case 1:
              ...
              return [4, this._sendMessage({
                ...
                params: {
                  transactions: transactions.map(function(transaction) {
                    return import_bs583.default.encode(transaction);
                  })
                }
              })];
            case 2:
              ...
              return [2, signedTransactions.map(function(transaction) {
                return import_bs583.default.decode(transaction);
              })];
            case 3:
              e_2 = _b.sent();
  ...
  function(_super) {
    ...
    function Solflare2(config) {
      ...
      _this._injectElement = function() {
        ...
        var params = __assign3(__assign3({}, _this._iframeParams), { cluster: _this._network || "mainnet-beta", origin: window.location.origin || "", title: document.title || "", version: 1, sdkVersion: VERSION || "unknown" });
      ...
      if (config === null || config === void 0 ? void 0 : config.params) {
        _this._iframeParams = __assign3({}, config === null || config === void 0 ? void 0 : config.params);
      }
      return _this;
    }
...
//# sourceMappingURL=esm-I5S6XDS3.js.map
