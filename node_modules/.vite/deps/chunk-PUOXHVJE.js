...
function decodeBytes(cursor, param, { staticPosition }) {
  ...
  const value = bytesToHex2(cursor.readBytes(Number.parseInt(size4, 10), 32));
  return [value, 32];
}
...
async function call(client, args) {
  ...
  try {
    ...
    const { offchainLookup: offchainLookup2, offchainLookupSignature: offchainLookupSignature2 } = await import("./ccip-UAXQ43PM.js");
...
//# sourceMappingURL=chunk-PUOXHVJE.js.map
