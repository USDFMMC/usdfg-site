...
var ICONS = {
  add: async () => (await import("./add-KVSXKOMQ.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-S5I6JXXV.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-TG3TYZLP.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-ZVSHFE26.js")).appStoreSvg,
  apple: async () => (await import("./apple-SCJ4AIWF.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-22SQLSC6.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-JFBDVURQ.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-ZK3LLA6K.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-6KYYEGNH.js")).arrowTopSvg,
  bank: async () => (await import("./bank-636Z7WZ5.js")).bankSvg,
  browser: async () => (await import("./browser-YM4AWWUF.js")).browserSvg,
  card: async () => (await import("./card-NA66MUN7.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-LW45XKEE.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-AKYBXORK.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-6MHVAZQT.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-36DZ5R7Z.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-CUQL54AR.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-BQEQVHKA.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-72W6ZD2V.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-PTVRSFRF.js")).clockSvg,
  close: async () => (await import("./close-ANDIBK7I.js")).closeSvg,
  compass: async () => (await import("./compass-XW2L6NVC.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-KU5IY74T.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-LOTCEOTD.js")).copySvg,
  cursor: async () => (await import("./cursor-OR4TO2H6.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-2LC5C67H.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-P3Z7O5SS.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-UZWBEXHZ.js")).disconnectSvg,
  discord: async () => (await import("./discord-6LVZKBEH.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-4VTDDFN6.js")).etherscanSvg,
  extension: async () => (await import("./extension-MO2DGXJU.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-NCP6AOIU.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-FOX22C4Q.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-QB5IIUOS.js")).farcasterSvg,
  filters: async () => (await import("./filters-RZOIGSCW.js")).filtersSvg,
  github: async () => (await import("./github-KJLUSKCZ.js")).githubSvg,
  google: async () => (await import("./google-EBIYGAKR.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-W37MPUQ3.js")).helpCircleSvg,
  image: async () => (await import("./image-W5BH5J4R.js")).imageSvg,
  id: async () => (await import("./id-3OUGW656.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-HV57NQ3S.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-BJQGMJW7.js")).lightbulbSvg,
  mail: async () => (await import("./mail-GCFN67Y7.js")).mailSvg,
  mobile: async () => (await import("./mobile-XLFSSDLY.js")).mobileSvg,
  more: async () => (await import("./more-RTFR7NAQ.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-VI22AKKO.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-WGHTUJE2.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-WTMX4NEB.js")).offSvg,
  playStore: async () => (await import("./play-store-J3L5HIH7.js")).playStoreSvg,
  plus: async () => (await import("./plus-IO7QIIQY.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-X6ULVVQP.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-MPKEO6HE.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-7QF5O4IQ.js")).refreshSvg,
  search: async () => (await import("./search-FCJGEBWX.js")).searchSvg,
  send: async () => (await import("./send-VOBBAOYO.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-7R56T5FP.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-XTMVUQ2Q.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-6GBEG5IB.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-35VDYGNG.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-63TMVPB7.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-J5W6GZFL.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-KWFLU52M.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-ZBABXIU4.js")).twitchSvg,
  twitter: async () => (await import("./x-UEY735TC.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-YSKGI3XY.js")).twitterIconSvg,
  verify: async () => (await import("./verify-AHUDC7MX.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-GT6GDXUR.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-GLXSK2RD.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-FUOME2JD.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-FUOME2JD.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-FUOME2JD.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-NO73TH6X.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-WDRW6VOH.js")).warningCircleSvg,
  x: async () => (await import("./x-UEY735TC.js")).xSvg,
  info: async () => (await import("./info-QCTJGTHR.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-SZVANRF2.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-NE6T3B64.js")).reownSvg
};
...
//# sourceMappingURL=chunk-L6E4GG3R.js.map
