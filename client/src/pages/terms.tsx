      ...
      <div className="relative flex flex-col md:flex-row">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-12 xl:px-20 py-12 sm:py-16 md:py-20">
          ...
          >
            ...
            <div data-terms-reveal className="max-w-2xl mx-auto mb-6 lg:mb-8 text-center">
            ...
            {/* Trust Badges */}
            <div data-terms-reveal className="flex flex-wrap justify-center gap-4 mb-8 lg:mb-12">
          ...
          <section data-terms-reveal className="whitepaper-section max-w-4xl mx-auto bg-black/40 backdrop-blur-sm border border-purple-500/20 p-6 sm:p-8 lg:p-10 rounded-lg shadow-lg mb-10 transform transition-all duration-300 hover:scale-[1.01] hover:shadow-[0_0_40px_rgba(147,51,234,0.3)] hover:border-purple-500/50">
              ...
              <div className="space-y-8 text-white">
                  ...
                  <div id="section-1" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 1. Legal Classification Statement</h3>
                    </div>
                  ...
                  <div id="section-2" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 2. Service Overview</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-3" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 3. Eligibility</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-4" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 4. Skill-Based Platform Only</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-5" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 5. Token Use & Risk Disclosure</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-6" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 6. User Conduct</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-7" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 7. Limitation of Liability</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-8" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 8. Platform Availability</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-9" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 9. Modifications</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-10" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 10. Termination</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-11" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 11. Governing Law</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-12" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 12. Contact</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                    <div className="bg-black/40 backdrop-blur-sm border border-purple-500/20 rounded-lg p-6 shadow-[0_0_16px_rgba(168,85,247,0.2)] max-w-lg mx-auto">
                  <ul className="list-disc pl-5 space-y-2">
                    <li>X (Twitter): <a href="https://twitter.com/USDFGAMING" className="bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent hover:underline" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>https://twitter.com/USDFGAMING</a></li>
                    ...
                    <li>Official Website: <a href="https://usdfg.pro" className="bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent hover:underline" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>USDFG.PRO</a></li>
                  </ul>
                    </div>
                </div>
                  ...
                  <div id="section-13" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 13. Dispute Resolution</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-14" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 14. No Financial Advice</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-15" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 15. User Responsibility</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-16" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 16. Assumption of Risk</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-17" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 17. Severability</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-18" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 18. Naming Notice</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-19" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 19. Indemnification</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-20" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 20. Jurisdictional Use</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-21" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 21. No Agency</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-22" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 22. No Ownership Rights</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-23" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 23. Token Acquisition and Use</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-24" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 24. Legal Safeguards and Gambling Exclusion</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-25" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 25. Third-Party Tools Disclaimer</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-26" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 26. Intellectual Property Ownership</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-27" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 26.1. Third-Party Game Publisher Disclaimer</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-28" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 26.2. Game IP Disclaimer</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-29" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 27. Token Use Limitation</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-30" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 28. Autonomous Execution Clause</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-31" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 29. No Promoter Liability</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-32" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 30. Wallet & Transaction Responsibility</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-33" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 31. International Use Exemption</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-34" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 32. Platform Fees and Use of Funds</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-35" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 33. No Guarantee of Earnings or Results</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-36" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 34. Acknowledgment of Blockchain Risks</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-37" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 35. No Fiduciary Relationship</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-38" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 36. Misuse, False Claims, and Public Harassment</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-39" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 37. Regulatory Cooperation and Jurisdiction</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-40" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 38. No Custodial Holdings or Token Sales</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-41" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 39. Community Participation Disclaimer</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-42" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 40. KYC / Identity Verification Disclaimer</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-43" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 41. Content Ownership</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-44" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 42. Challenge Dispute Resolution System</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-45" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 43. Affiliate or Referral System Terms</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-46" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 44. AI Use and Automation Disclosure</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-47" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 45. Analytics and Anti-Cheat Monitoring</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-48" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 46. Bounty & Community Reward Programs</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-49" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 47. Platform Lifecycle and Discontinuation</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-50" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 48. Legal Jurisdiction Flexibility</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-51" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 49. Community Content and AI Use</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-52" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 50. DAO Participation Disclaimer</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-53" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 51. Successor Entity and Assignment</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-54" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 52. AI Gameplay Systems and Disclaimers</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-55" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 53. Account Suspension Review</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-56" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 54. Token Migration and Upgrade</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-57" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 55. Data Retention and Access</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-58" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 56. No Service-Level Guarantee</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-59" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 57. Regulatory Change Disclaimer</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-60" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 58. Sponsored Content & Advertising</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-61" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 59. AI and User-Generated Content Usage</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-62" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 60. Community Governance (Non-Binding)</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-63" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 61. Third-Party Hosted Events</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-64" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 62. Not a Security</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-65" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 63. Non-Custodial Disclaimer</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-66" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 64. Platform Snapshot Rights</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-67" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 65. Forking & Derivative Work Restrictions</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-68" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 66. Platform Integrity Enforcement</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-69" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 67. Multichain Integration Disclaimer</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-70" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 68. Fixed Supply Statement</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-71" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 69. Smart Contract Stability Notice</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
                  ...
                  <div id="section-72" className="animate-fade-in">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]"></span>
                      <h3 className="text-xl font-semibold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-400 bg-clip-text text-transparent tracking-wide" style={{ filter: "drop-shadow(0 0 4px rgba(251, 191, 36, 0.3))" }}>→ 70. Related Policies</h3>
                    </div>
                    <div className="border-t border-amber-400/30 mb-4"></div>
