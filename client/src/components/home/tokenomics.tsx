      ...
      <div ref={wrapperRef} className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-12 xl:px-20">
        ...
        <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 max-w-5xl mx-auto mb-8 lg:mb-12">
          <div
            ...
            style={{ "--neon-color": "rgba(126, 67, 255, 0.25)", "--neon-hover-color": "rgba(126, 67, 255, 0.45)" } as React.CSSProperties}
          ...
          >
            ...
            <div className="relative z-10">
              <p className="font-display text-3xl md:text-4xl lg:text-5xl font-extrabold mb-2 text-gradient">{val1}%</p>
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-purple-600/0 via-purple-600/10 to-purple-600/0 opacity-0 hover:opacity-100 transition-opacity duration-300 rounded-2xl" />
            <div className="relative z-10">
              <p className="font-display text-3xl md:text-4xl lg:text-5xl font-extrabold mb-2 text-gradient">{val2}%</p>
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-purple-600/0 via-purple-600/10 to-purple-600/0 opacity-0 hover:opacity-100 transition-opacity duration-300 rounded-2xl" />
            <div className="relative z-10">
              <p className="font-display text-3xl md:text-4xl lg:text-5xl font-extrabold mb-2 text-gradient">{val3}%</p>
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-purple-600/0 via-purple-600/10 to-purple-600/0 opacity-0 hover:opacity-100 transition-opacity duration-300 rounded-2xl" />
            <div className="relative z-10">
              <p className="font-display text-3xl md:text-4xl lg:text-5xl font-extrabold mb-2 text-gradient">{val4}%</p>
        ...
        >
          <h3 className="font-display text-lg lg:text-xl font-bold mb-3 text-gradient">Token Utility and Supply</h3>
          ...
          <p className="font-body text-white/70 text-sm md:text-base mt-2 leading-relaxed">USDFG is used for platform access, challenge creation, and participation in skill-based competition.</p>
