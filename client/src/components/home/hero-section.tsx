...
const HeroSection: React.FC<HeroSectionProps> = ({ onExploreClick }) => {
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 z-[1] animate-kimi-reveal"
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-12 xl:px-20 pt-20">
        <div className="w-full">
          <div className="flex flex-col items-start text-left max-w-4xl">
            <div
              className="text-2xl md:text-3xl lg:text-4xl font-bold mb-2 text-white opacity-0 animate-kimi-in kimi-delay-1"
              style={{ textShadow: "0 0 20px rgba(255, 255, 255, 0.3)" }}
            >
              USDFG
            </div>

            <h1 className="neocore-h1 mb-4 text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-tight opacity-0 animate-kimi-in kimi-delay-2">
            ...
            <p className="neocore-body mb-4 max-w-2xl text-lg sm:text-xl text-white/70 leading-relaxed opacity-0 animate-kimi-in kimi-delay-3">
            ...
            <div className="flex flex-col sm:flex-row justify-start gap-4 opacity-0 animate-kimi-in kimi-delay-4">
              <button
      ...
      <div
        className="absolute bottom-1/3 right-1/3 w-48 h-48 bg-orange-500/10 rounded-full blur-[80px] animate-pulse-glow"
