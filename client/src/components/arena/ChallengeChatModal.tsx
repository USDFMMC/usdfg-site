      ...
      {isMinimized ? (
        <div className="fixed bottom-20 right-4 z-40 md:bottom-24 md:right-6">
          <button
            ...
            className="px-3 py-1.5 bg-gradient-to-r from-amber-600/90 to-orange-500/90 text-white rounded-lg shadow-[0_0_15px_rgba(255,215,130,0.2)] hover:brightness-110 transition-all flex items-center gap-1.5 text-sm font-medium border border-amber-400/30"
          >
        ...
        <div className="fixed top-0 right-0 h-full w-full sm:w-96 md:w-[420px] z-40 flex flex-col bg-[#07080C]/98 backdrop-blur-md border-l border-amber-400/20 shadow-[0_0_40px_rgba(0,0,0,0.5)]">
          {/* Header */}
          <div className="flex items-center justify-between p-3 border-b border-amber-400/20 bg-[#07080C]/95">
            <div className="flex-1 min-w-0">
              <h3 className="text-base font-bold text-white truncate">Chat</h3>
