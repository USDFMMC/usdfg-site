...
pub const PLATFORM_WALLET: &str = "AcEV5t9TJdZP91ttbgKieWoUxwUb4PT4MxvggDjjkkq";
...
pub mod usdfg_smart_contract {
    ...
    pub fn accept_challenge(ctx: Context<AcceptChallenge>) -> Result<()> {
        ...
        // ✅ SECURITY: Verify not expired (prevents joining old/stale challenges)
        // This is the CORRECT use of dispute_timer - prevents joining expired challenges
        require!(
    ...
    /// ✅ FIXED: Winners can claim prizes ANYTIME after completion (no expiration)
    pub fn resolve_challenge(
        ...
        // ORIGINAL PURPOSE: The dispute_timer was meant to prevent delayed disputes/resolutions
        // THE PROBLEM: It was incorrectly blocking prize claims AFTER completion
        // THE FIX: Once both players submit results and challenge is completed,
        // winners should be able to claim prizes ANYTIME (no time limit).
        // SECURITY NOTE: The dispute_timer still correctly prevents joining expired challenges
        // (checked in accept_challenge), but should NOT block claiming completed prizes.
